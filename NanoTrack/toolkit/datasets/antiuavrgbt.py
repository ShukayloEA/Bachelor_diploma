...
class AntiUAVRGBTVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(AntiUAVRGBTVideo, self).__init__(name, root, video_dir,
...
class AntiUAVRGBTDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(AntiUAVRGBTDataset, self).__init__(name, dataset_root)
        ...
        self.anno_files = sorted(glob.glob(
            os.path.join(dataset_root, '*/test_visible/gt_visible.txt')))
        ...
        for  video in pbar:
           #pbar.set_postfix_str(video)
            self.videos[video] = AntiUAVRGBTVideo(video,
                                          dataset_root,
